...
alias pllint='pod lib lint --sources=http://gitlab.lizhi.fm/iOSPods/LizhiSpecs.git --use-libraries --fail-fast --verbose --allow-warnings --skip-import-validation'
